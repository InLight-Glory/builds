...
class Vessel {
    ...
    update(deltaTime, keysPressed, camera, mouseWorldPosition) {
        // --- Rotation Logic ---
        // The vessel should always look at the mouse cursor's position on the ground.
        // We set the y-component to the vessel's y-position to prevent it from tilting up or down.
