...
<head>
    ...
    <link rel="stylesheet" href="radial_menu.css?v=<?php echo time(); ?>">
    </head>
<body>
    ...
    <div id="ui-overlay">
        ...
        <!-- Blueprint-specific prompt -->
        <div id="blueprint-prompt" style="display: none;">
    ...
    <script src="hud.js?v=<?php echo time(); ?>"></script>
